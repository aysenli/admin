 ...
 <div class="box box-primary"> 
  ...
  <div class="box-body"> 
   ...
   <div class="form-group col-xs-12"> 
        <label><span style="display:block;">权限名称：</span></label> 
        <input name="name" type="text" class="form-control" placeholder="模糊搜索权限名称" value="{{\Input::get('name')}}"  />
        <button type="submit" class="btn btn-success">查询</button>   
   </div> 
  </div> 
  <div class="box-footer"> 
    <a href="/admin/menu/add" class="btn btn-primary">新增</a>
  </div>
  <!-- /.box-header --> 
 </div>
 <!-- /.box --> 
